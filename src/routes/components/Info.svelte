...
<div class="info-card">
  ...
  <ul>
    ...
    <li>
      <img src={agreements} alt="" />
      <p>{$_("info.agreements")}</p>
    </li>
    <li>
      <svg
        fill="#29225c"
